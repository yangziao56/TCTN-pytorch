import validation
import numpy as np
from validation.binary.score import ts_hfmc, ets_hfmc, bias_hfmc, far_hfmc, mr_hfmc

IV = 999999
# github:https://github.com/nmcdev/meteva/tree/master/meteva/method
...
def tcof(ob, fo, grade_list=None):
    ...
    for line in range(new_Fo_shape[0]):
        ...
        ft = validation.mutil.table.frequency_table(ob, new_Fo[line, :], grade_list=grade_list)
...
def hss(ob, fo, grade_list=None):
    ...
    for line in range(new_Fo_shape[0]):
        ...
        conf_mx = validation.mutil.table.contingency_table_multicategory(ob, new_Fo[line, :], grade_list)
